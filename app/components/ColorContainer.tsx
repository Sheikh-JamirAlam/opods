    ...
    <div className="py-12 flex flex-col justify-center items-center gap-14 overflow-hidden">
      ...
      <div className="flex items-center justify-center">
        <h1
          ...
          } w-full text-center font-calligraphy text-[100px] xs:text-[150px] sm:text-[200px] lg:text-[275px] xl:text-[350px] 2xl:text-[490px] absolute z-0`}
        >
          {color}
        </h1>
        <div
          className={`w-[125px] h-[125px] xs:w-[200px] xs:h-[200px] sm:w-[250px] sm:h-[250px] lg:w-[350px] lg:h-[350px] xl:w-[400px] xl:h-[400px] 2xl:w-[550px] 2xl:h-[550px] image-overlay ${color.toLowerCase()} transition-all`}
        ></div>
        <Image className="w-[125px] xs:w-[200px] sm:w-[250px] lg:w-[350px] xl:w-[400px] 2xl:w-[550px] block z-10" src="/images/OPods.png" width={550} height={550} alt="Image of our OPods" />
      </div>
      <p
