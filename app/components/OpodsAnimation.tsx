...
export default function ScrollVideo() {
  ...
  return (
    <div className="h-[300vh] relative" ref={scrollRef}>
      ...
      <div style={{ opacity: opacity.get() >= 0.9 ? 1 : opacity.get() }} className="w-64 absolute top-[50vh] left-[76rem] flex flex-col text-lg font-medium">
      ...
      <div style={{ opacity: opacitySecond.get() >= 0.9 ? 1 : opacitySecond.get() }} className="w-72 absolute top-[130vh] left-[80rem] flex flex-col text-lg font-medium">
      ...
      <div style={{ opacity: opacityThird.get() >= 0.9 ? 1 : opacityThird.get() }} className="w-[17rem] absolute top-[240vh] left-[85rem] flex flex-col text-lg font-medium">
